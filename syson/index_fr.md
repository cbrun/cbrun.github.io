...
Pour les choix d'architecture et de produit qui se cachent derrière un tel environnement, consultez [Concevoir une plateforme de modélisation adaptée à son métier]({{ site.url }}/fr/modeling-platforms/).
