...
<div class="topics-directory">
  <article class="topic-card topic-card--sysml">
    <h3><a href="{{ site.url }}/sysml-v2/">SysML v2</a></h3>
    <p>Understand what the new standard changes, compare it with SysML v1, and prepare a progressive MBSE adoption.</p>
  </article>
  <article class="topic-card topic-card--syson">
    <h3><a href="{{ site.url }}/syson/">Eclipse SysON</a></h3>
    <p>Evaluate an open-source, web-based SysML v2 environment and understand the engineering choices behind it.</p>
  </article>
  <article class="topic-card topic-card--platforms">
    <h3><a href="{{ site.url }}/modeling-platforms/">Modeling platforms</a></h3>
    <p>Decide whether to buy, configure, or build a modeling environment for your domain and organization.</p>
  </article>
  <article class="topic-card topic-card--opensource">
    <h3><a href="{{ site.url }}/open-source-industrial/">Industrial open source</a></h3>
    <p>Assess governance, funding, sovereignty, and maintenance when open source becomes critical infrastructure.</p>
  </article>
