...
> **2026 update:** SysON has since become an active Eclipse project with regular releases. For its current scope, architecture, capabilities, and evaluation criteria, see [Eclipse SysON: an open-source SysML v2 modeling environment]({{ site.url }}/syson/).
