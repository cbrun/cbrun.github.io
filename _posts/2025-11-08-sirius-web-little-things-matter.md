...
* **Appearance customization** extended to edges and all remaining node types, with extension points for custom node appearance.
* **Labels that behave.** Move edge and external node labels directly on the diagram, or hide them. A pin option is planned to lock positions.
* **Drop feedback that matches your intent.** New nodes land centered under the cursor for precise placement.
