...
## Eclipse Modeling Package M6 for Neon has just been published and is ready for testing !
...
Here are some noteworthy changes I'm aware of:
...
(I'm looking at you UML). The Sirius team found a strategy which should meet the requirements of 100% of the resource implementations we know of, and a specific strategy can be plugged in for the other ``%`` we don't know of ;)
