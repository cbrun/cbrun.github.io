...
> **Mise à jour 2026 :** SysON est depuis devenu un projet Eclipse actif, avec des versions régulières. Pour découvrir son périmètre actuel, son architecture, ses capacités et les critères permettant de l'évaluer, consultez [Eclipse SysON : un environnement de modélisation SysML v2 open source]({{ site.url }}/fr/syson/).
